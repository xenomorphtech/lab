defprotocol Gyx.Core.Spaces do
  ...
  """
  @type space :: Lab.Struct.Discrete.t() | Lab.Struct.Box.t() | Lab.Struct.Tuple.t()
...
defimpl Gyx.Core.Spaces, for: Lab.Struct.Discrete do
...
defimpl Gyx.Core.Spaces, for: Lab.Struct.Box do
  def sample(box_space) do
    random_action =
      box_space.shape
      |> Lab.Struct.Tuple.to_list()
  ...
  def contains?(box_space, box_point) do
    with shape_expected <- Lab.Struct.Tuple.to_list(box_space.shape),
